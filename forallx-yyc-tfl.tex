...
Ela não é uma expressão específica da LPC, como `$A$', mas uma variável da metalinguagem (metavariável) que se refere genericamente a qualquer expressão da LPC, tal como $$A,\ \ B,\ \  (A \eif (Q \eand R)),\ \  \enot\enot(B_3 \eif Z),\ \ldots$$
