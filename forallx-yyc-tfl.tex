...
e este outro também:
	...
	\end{earg}
Ambos os argumentos são válidos e não é difícil notar que eles compartilham uma estrutura ou forma comum, em conformidade com a Seção \ref{s:ValidadeFormal}, que pode ser expressada assim:
	\begin{earg}
		\item[] $A$
		\item[] Se $A$, então $C$
		\item[\therefore] $C$
